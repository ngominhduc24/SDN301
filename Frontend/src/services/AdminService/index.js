...
import {apiAddNewUsers, apiAddProducts, apiGetAllCategories, apiGetAllProducts, apiGetAllStores, apiGetAllUsers, apiGetCategoryById, apiGetProductById, apiGetProductInStore, apiGetStoreById, apiGetUserDetail, apiUpdateProducts, apiUpdateStatusUser, apiUpdateStores} from './url'
...
const AdminServices = {
      getAllProducts, getAllStores, getStoreById, getAllManagers, getManagerById, updateStatusUsers, getUserDetail, addnewUsers, addNewProduct, getProductById, updateProducts, getAllCategories, getCategoryById, getProductInStore, updateStores
}
